...
public class YuvRegistPresenterImpl implements YuvRegistPresenter {
    ...
    @Override
    public void registerFace(byte[] data, final int w, final int h, final MyCallBack callBack) {
        if (tag) {
            return;
        }
        tag = true;
        ...
        FaceDetectManager.detectFace(data, w, h, new DetectListener() {
            ...
            public void onSuccess(List<DetectBean> detectBeanList) {
                if (detectBeanList.size() == 0) {
                    ...
                    mView.noFace();
                    if(callBack != null){
                        callBack.callBackCamera("detect no face");
                    }
                    return;
                }
            ...
            public void onError(Status status, String s) {
                ...
                if(callBack != null){
                    callBack.callBackCamera("detect face error");
                }
