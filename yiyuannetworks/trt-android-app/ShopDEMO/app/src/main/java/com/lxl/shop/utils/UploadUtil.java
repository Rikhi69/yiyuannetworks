...
public class UploadUtil {
     ...
     */
    public void uploadFile(String filePath, String RequestURL, Map<String, String> param) {
        if (filePath == null) {
    ...
    public void toUploadFile(File file, String RequestURL, Map<String, String> param) {
        String result = null;
        requestTime = 0;
