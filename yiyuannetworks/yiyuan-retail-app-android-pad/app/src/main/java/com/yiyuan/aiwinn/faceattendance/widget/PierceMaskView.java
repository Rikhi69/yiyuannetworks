...
public class PierceMaskView extends ImageView {
    ...
    private int mRectX,mRectY,mRectW,mRectH;
    private int mBgRectX,mBgRectY,mBgRectW,mBgRectH;
    ...
    public void setRectPosition(int mRectX, int mRectY, int mRectW, int mRectH) {
        this.mRectX = mRectX==0?mScreenWidth:mRectX;
        this.mRectY = mRectY==0?mScreenHeight:mRectY;
        this.mRectW = mRectW==0?mScreenWidth:mRectW;
        this.mRectH = mRectH==0?mScreenHeight:mRectH;
    }
    ...
    private Bitmap makeDstRect() {
        ...
        Canvas canvcs = new Canvas(bm);
        Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        canvcs.drawRect(mRectX,mRectY,mRectX+mRectW,mRectY+mRectH,paint);
        return bm;
    }
