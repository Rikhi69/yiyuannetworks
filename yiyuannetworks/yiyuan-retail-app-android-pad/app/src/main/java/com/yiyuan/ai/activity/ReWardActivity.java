...
public class ReWardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ai_activity_reward);
        ...
        wheelSurfView.setRotateListener(new RotateListener() {
            ...
            public void rotateEnd(int position, String des) {
                Toast.makeText(ReWardActivity.this, "结束了 " + position + "   " + des, Toast.LENGTH_SHORT).show();
            }
        ...
        wheelSurfView1.setRotateListener(new RotateListener() {
            @Override
            public void rotateEnd(int position, String des) {
                Toast.makeText(ReWardActivity.this, "结束了 位置：" + position + "   描述：" + des, Toast.LENGTH_SHORT).show();
            }
