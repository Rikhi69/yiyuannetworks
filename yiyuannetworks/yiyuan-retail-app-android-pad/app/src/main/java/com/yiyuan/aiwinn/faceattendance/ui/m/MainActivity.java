...
import com.yiyuan.aiwinn.faceattendance.adapter.ActivityAdapter;
...
public class MainActivity extends BaseActivity implements View.OnClickListener ,PermissionUtils.FullCallback{
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                switch (position){
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        mIntent.setClass(MainActivity.this, AiMainActivity.class);
                        startActivity(mIntent);
                        break;
                }
            }
    ...
    public void startAiMainActivity(){
        mIntent.setClass(MainActivity.this, AiMainActivity.class);
        startActivity(mIntent);
        finish();
    }
