...
public class BmpRegistPresenterImpl implements BmpRegistPresenter {
    ...
    @Override
    public void registUser(File file, String name, String customerId, String customerGender) {
        Bitmap bitmap = ImageUtils.getBitmap(file);
        registUser(bitmap, name, customerId, customerGender);
    }

    @Override
    public void registUser(Bitmap bitmap, final String customerName, final String customerId, final String customerGender) {
        LogUtils.d(HEAD, "start detect face by bmp");
        FaceDetectManager.detectFace(bitmap, new DetectListener() {
