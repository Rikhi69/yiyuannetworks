...
import com.yiyuan.aiwinn.faceattendance.adapter.DetectAdapter;
...
import com.yiyuan.aiwinn.faceattendance.widget.MaskView;
...
public class DetectActivity extends BaseActivity implements CameraInterfaceBak.CameraStateCallBack, DetectView {
    ...
    public void cameraHasOpened() {
        ...
        CameraInterfaceBak.getInstance().doStartPreview(mSurfaceView.getSurfaceHolder());
    }
